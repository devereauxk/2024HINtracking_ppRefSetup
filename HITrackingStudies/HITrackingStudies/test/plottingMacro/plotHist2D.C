...
void plotHist2D() {
  ...
  //TFile *f = new TFile("/eos/cms/store/group/phys_heavyions/rpradhan/Tracking_ppref_5p36TeV/Pythia8_LowPU_0p5MEvents_TuneCP5_5360GeV/Pythia_LowPU_NoTrigger_5p36TeV_ptReso0p1/250205_153431/0000/Pythia_LowPU_NoTrigger_5p36TeV_ptReso0p1.root");
  //TFile *f = new TFile("/eos/cms/store/group/phys_heavyions/rpradhan/Tracking_ppref_5p36TeV/Pythia8_LowPU_0p5MEvents_TuneCP5_5360GeV/Pythia_LowPU_NoTrigger_5p36TeV_NoptReso/250205_153542/0000/Pythia_LowPU_NoTrigger_5p36TeV_NoptReso.root");
  //TFile *f = new TFile("/eos/cms/store/group/phys_heavyions/rpradhan/Tracking_ppref_5p36TeV/Pythia8_LowPU_0p5MEvents_TuneCP5_5360GeV/Pythia_LowPU_NoTrigger_5p36TeV_ptResoAfterpT10GeV/250205_153737/0000/Pythia_LowPU_NoTrigger_5p36TeV_ptResoAfterpT10GeV.root");
  
  //TFile *f = new TFile("/eos/cms/store/group/phys_heavyions/rpradhan/Tracking_ppref_5p36TeV/Pythia8_NoPU_0p5MEvents_TuneCP5_QCD_ptHat15_5360GeV/Pythia_NoPU_TuneCP5_QCD_ptHat15_NoTrigger_5p36TeV_ptResoAfterpT10GeV/250208_213035/0000/Pythia_NoPU_TuneCP5_QCD_ptHat15_NoTrigger_5p36TeV_ptResoAfterpT10GeV.root");
  ...
  TH1D* hDumPt = new TH1D("hDumPt",";p_{T} [GeV/c]",80,0.1,120.0); hDumPt->SetMaximum(1.0);
  ...
  hDumEtaFak=(TH1F*) hDumEta2->Clone("hDumEtaMul"); fixedFontHist1D(hDumEtaFak, 1.05,1.2); hDumEtaFak->GetYaxis()->SetRangeUser(0.,1);
...
//  c9->GetPad(2)->SetLogx();
  ...
  hDumEtaSec=(TH1F*) hDumEta2->Clone("hDumEtaMul"); fixedFontHist1D(hDumEtaSec, 1.05,1.3); hDumEtaSec->GetYaxis()->SetRangeUser(0.,0.015);

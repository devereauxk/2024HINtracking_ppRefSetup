...
process.TFileService = cms.Service("TFileService", fileName = cms.string('LowPU_Pythia_5p36TeV.root'))
...
#process.HITrackCorrections.ptErrMax = 0.1 # no cut basically
...
process.HITrackCorrections.vtxWeightParameters = cms.vdouble(0.895491, -0.0124438, 0.00369163, -6.87949e-06)
###
